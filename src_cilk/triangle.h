...
public:
	...
	Triangle (const Vector3& a, const Vector3& b, const Vector3& c, Attribute* attr);
	Triangle (const Vector3& a, const Vector3& b, const Vector3& c, const Vector3& ta, const Vector3& tb, const Vector3& tc);
	Triangle (const Vector3& a, const Vector3& b, const Vector3& c, const Vector3& ta, const Vector3& tb, const Vector3& tc, Attribute* attr);
